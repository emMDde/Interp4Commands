...
The engine reads custom `.cmd` scripts that defines actions. Program supports arbitrarily nested both sequential and parallel execution blocks, allowing for complex, multi-level action synchronization.Example:
...
Set Ob_A 2 0 0 30 0 0 

Set Ob_B 10 10 5 0 0 0 
